/*** Generated by streamline 0.4.5 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename),__func=__rt.__func,__cb=__rt.__cb,__tryCatch=__rt.__tryCatch; var async = require("async");
...
exports.init = function(cli) {
  ...
  profile.addKnownProvider("website");
  ...
  site.command("list [name]").description($("List your web sites")).option("-s, --subscription <id>", $("the subscription id")).execute(function __1(name, options, _) { var context, sites; var __frame = { name: "__1", line: 67 }; return __func(_, this, arguments, __1, 2, __frame, function __$__1() {
      ...
      return ensureSpaces(context, __cb(_, __frame, 6, 10, function __$__1() {
        return site.doSitesGet(context, __cb(_, __frame, 7, 22, function ___(__0, __1) { sites = __1;
  ...
  site.command("set [name]").description($("Set configuration options for your web site [name]")).option("--slot <slot>", $("the name of the slot")).option("--net-version <net-version>", $("the .NET version. Valid options are v3.5 and v4.5")).option("--php-version <php-version>", $("the PHP version. Valid options are off, v5.3 and v5.4")).option("--platform <platform>", $("the platform. Valid options are x86 and x64")).option("-w, --web-socket", $("use this flag to enable web sockets")).option("-W, --disable-web-socket", $("use this flag to disable web sockets")).option("-r, --remote-debugging", $("use this flag to enable remote debugging")).option("-R, --disable-remote-debugging", $("use this flag to disable remote debugging")).option("-d, --remote-debugging-version <remote-debugging-version>", $("the version of remote debugging. It's either VS2012 or VS2013. This parameter is only valid when remote debugging is on.")).option("-m, --managed-pipeline-mode <managed-pipeline-mode>", $("the mode for managed pipeline. valid values are Classic and Integrated.")).option("-s, --subscription <id>", $("the subscription id")).execute(function __2(name, options, _) { var parsedSiteName, context, siteConfigurations; var __frame = { name: "__2", line: 113 }; return __func(_, this, arguments, __2, 2, __frame, function __$__2() {
      ...
      return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 26, 6, function __$__2() {
        siteConfigurations = { };
        ...
        return site.doSiteConfigPUT(siteConfigurations, context, __cb(_, __frame, 67, 6, _, true)); }, true)); }); });



  var deploymentScriptCommand = site.command("deploymentscript");
  kuduscript.addDeploymentScriptOptions(deploymentScriptCommand);
  deploymentScriptCommand.execute(function __3(name, options, _) { var __frame = { name: "__3", line: 186 }; return __func(_, this, arguments, __3, 2, __frame, function __$__3() {
      return kuduscript.deploymentScriptExecute(name, options, log, function() { cli.interaction.confirm.apply(cli.interaction, arguments); }, __cb(_, __frame, 1, 4, _, true)); }); });
  ...
  site.command("create [name]").description($("Create a web site")).option("--location <location>", $("the geographic region to create the website")).option("--hostname <hostname>", $("the custom host name to use")).option("--slot <slot>", $("the name of the slot")).option("--git", $("Configure git on web site and local folder")).option("--gitusername <gitusername>", $("the publishing username for git")).option("--github", $("Configure github on web site and local folder")).option("--githubusername <username>", $("the github username")).option("--githubpassword <password>", $("the github password")).option("--githubrepository <repository>", $("the github repository full name (i.e. user/repository)")).option("-s, --subscription <id>", $("the subscription id")).execute(function __4(nameArg, options, _) { var context, websiteClient;
    ...
    function promptForSiteName(_) { var __frame = { name: "promptForSiteName", line: 280 }; return __func(_, this, arguments, promptForSiteName, 0, __frame, function __$promptForSiteName() {
        log.silly("promptForSiteName"); return (function __$promptForSiteName(__then) {
          if ((context.site.name === undefined)) {
            ...
            return cli.interaction.prompt($("Name: "), __cb(_, __frame, 4, 34, function ___(__0, __1) { context.site.name = __1; __then(); }, true)); } else { __then(); } ; })(_); }); };



    function determineIfSiteAndSlotExists(_) { var sites, siteHits, displayNameMatches, slotHits, displaySlotNameMatches; var __frame = { name: "determineIfSiteAndSlotExists", line: 288 }; return __func(_, this, arguments, determineIfSiteAndSlotExists, 0, __frame, function __$determineIfSiteAndSlotExists() {
    ...
    function promptForLocation(_) { var locations, location; var __frame = { name: "promptForLocation", line: 343 }; return __func(_, this, arguments, promptForLocation, 0, __frame, function __$promptForLocation() {
        log.silly("promptForLocation");
        return ensureSpaces(context, __cb(_, __frame, 2, 12, function __$promptForLocation() {

          return site.doAvailableLocationsGet(context, __cb(_, __frame, 4, 28, function ___(__0, __1) { locations = __1;
            location = null; return (function __$promptForLocation(__then) {
              ...
              if ((!context.site.location && !context.site.webspace)) {
                ...
                return cli.interaction.choose(locations.map(function(location) {
                  return location.name; }), __cb(_, __frame, 9, 35, function ___(__0, __2) { location = locations[__2]; __then(); }, true)); } else {
    ...
    function updateLocalConfigWithSiteName(_) { var cfg; var __frame = { name: "updateLocalConfigWithSiteName", line: 374 }; return __func(_, this, arguments, updateLocalConfigWithSiteName, 0, __frame, function __$updateLocalConfigWithSiteName() {
        log.silly("updateLocalConfigWithSiteName"); return (function __$updateLocalConfigWithSiteName(__then) {
          if (context.flags.isGitWorkingTree) {
            return websiteClient.readConfig(__cb(_, __frame, 3, 24, function ___(__0, __1) { cfg = __1;
              cfg.name = context.site.name;
              cfg.slot = context.site.slot;
              cfg.webspace = context.site.webspace;
              return websiteClient.writeConfig(cfg, __cb(_, __frame, 7, 14, __then, true)); }, true)); } else { __then(); } ; })(_); }); };



    function createSite(_) { var site, websiteAddress; var __frame = { name: "createSite", line: 385 }; return __func(_, this, arguments, createSite, 0, __frame, function __$createSite() {
        log.silly("createSite"); return (function __$createSite(__then) {
          if (!context.flags.siteExists) {
            ...
            return websiteClient.getHostNameSuffix(context.subscription, __cb(_, __frame, 13, 61, function ___(__0, __1) { websiteAddress = ((context.site.name + ".") + __1);
              ...
              return websiteClient.createSite(context.subscription, context.site.webspace, site, __cb(_, __frame, 20, 21, _, true)); }, true)); } else { __then(); } ; })(_); }); };



    function createSiteSlot(_) { var site; var __frame = { name: "createSiteSlot", line: 409 }; return __func(_, this, arguments, createSiteSlot, 0, __frame, function __$createSiteSlot() {
  ...
  location.command("list").description($("List locations available for your account")).execute(function __5(options, _) { var context, locations; var __frame = { name: "__5", line: 427 }; return __func(_, this, arguments, __5, 1, __frame, function __$__5() {
      ...
      return site.doAvailableLocationsGet(context, __cb(_, __frame, 5, 26, function ___(__0, __1) { locations = __1;
        log.table(locations, function(row, item) {
          row.cell($("Name"), item.name); }); _(); }, true)); }); });



  site.command("browse [name]").description($("Open your web site in a browser")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __6(name, options, _) { var parsedSiteName, context, cache, siteData, href; var __frame = { name: "__6", line: 442 }; return __func(_, this, arguments, __6, 2, __frame, function __$__6() {
  ...
  site.command("show [name]").description($("Show details for a web site")).option("-d, --details", $("show additional site details")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __7(name, options, _) { var parsedSiteName, context, websiteClient, result, repositoryUri, gitUri, settings, diagnosticsSettings, siteInstances, data, showProperty, index, dSetting; var __frame = { name: "__7", line: 468 }; return __func(_, this, arguments, __7, 2, __frame, function __$__7() {
      ...
      return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 11, 10, function __$__7() {

        log.info($("Showing details for site"));
        log.verbose($("Parameters"), context);

        return async.parallel([function __1(_) { var __frame = { name: "__1", line: 485 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
            return site.doSiteGet(context, __cb(_, __frame, 0, 34, _, true)); });
        },function __2(_) { var __frame = { name: "__2", line: 486 }; return __func(_, this, arguments, __2, 0, __frame, function __$__2() { return site.doSiteConfigGet(context, __cb(_, __frame, 0, 34, _, true)); }); },], __cb(_, __frame, 16, 23, function ___(__0, __3) { result = __3;
          ...
          diagnosticsSettings = { }; return (function __$__7(__then) {
            ...
            if (repositoryUri) { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__7() {
                    ...
                    return site.ensureRepositoryUri(context, __cb(_, __frame, 29, 14, function __$__7() {
                      return site.category("repository").doSettingsGet(context, __cb(_, __frame, 30, 25, function ___(__0, __4) { settings = __4;
                        return websiteClient.getDiagnosticsSettings(context, __cb(_, __frame, 31, 36, function ___(__0, __5) { diagnosticsSettings = __5; __then(); }, true)); }, true)); }, true)); }); })(function ___(e, __result) { __tryCatch(_, function __$__7() { if (e) {


                      log.verbose("SCM Error", e.message.toString()); __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, __then); }); } else { __then(); } ; })(function __$__7() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__7() {





                  return site.doSiteInstancesGet(context, __cb(_, __frame, 40, 28, function ___(__0, __6) { siteInstances = __6; __then(); }, true)); }); })(function ___(e, __result) { __tryCatch(_, function __$__7() { if (e) {


                    siteInstances = []; __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, function __$__7() { return (function __$__7(__then) {
  ...
  site.command("delete [name]").description($("Delete a web site")).option("-q, --quiet", $("quiet mode, do not ask for delete confirmation")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __8(name, options, _) { var parsedSiteName, context, progress, service, siteName; var __frame = { name: "__8", line: 664 }; return __func(_, this, arguments, __8, 2, __frame, function __$__8() {
      ...
      return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 14, 10, function __$__8() { return (function __$__8(__then) {

          if (!options.quiet) { return (function __$__8(__then) {
              if (!context.site.slot) {
                return cli.interaction.confirm(util.format("Delete site %s? [y/n] ", context.site.name), __cb(_, __frame, 18, 19, function ___(__0, __2) { var __1 = !__2; return (function __$__8(__then) { if (__1) { return _(null); } else { __then(); } ; })(__then); }, true)); } else {


                return cli.interaction.confirm(util.format("Delete site %s in slot %s? [y/n] ", context.site.name, context.site.slot), __cb(_, __frame, 21, 24, function ___(__0, __4) { var __3 = !__4; return (function __$__8(__then) { if (__3) { return _(null); } else { __then(); } ; })(__then); }, true)); } ; })(__then); } else { __then(); } ; })(function __$__8() {
          ...
          progress = cli.interaction.progress($("Deleting site")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__8() {
                ...
                return service.webSites.delete(context.site.webspace, siteName, {
                  deleteMetrics: true,
                  deleteEmptyServerFarm: true,
                  deleteAllSlots: !options.slot }, __cb(_, __frame, 31, 12, function __$__8() {


                  return cacheUtils.deleteSite(context.subscription, siteName, __cb(_, __frame, 37, 12, function __$__8() { _(null, null, true); }, true)); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__8() {
  ...
  site.command("swap <name> [slot1] [slot2]").description($("Swap two web site slots")).option("-q, --quiet", $("quiet mode, do not ask for swap confirmation")).option("-s, --subscription <id>", $("the subscription id")).execute(function __9(name, slot1, slot2, options, _) { var parsedSiteName, context, sites, slots, verifySlotExists, progress, service; var __frame = { name: "__9", line: 713 }; return __func(_, this, arguments, __9, 4, __frame, function __$__9() {
      ...
      return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 13, 10, function __$__9() {

        return site.doSitesGet(context, __cb(_, __frame, 15, 22, function ___(__0, __2) { sites = __2;
          ...
          if ((slots.length === 2)) {
            ...
            var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Swap slot \"%s\" from site \"%s\" with slot \"%s\" ? [y/n] "), slot1, context.site.name, slot2), __cb(_, __frame, 57, 33, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -712, 18, function ___(__0, __3) { return (function __$__9(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$__9() {
              ...
              progress = cli.interaction.progress(util.format($("Swapping slot \"%s\" from site \"%s\" with slot \"%s\""), slot1, context.site.name, slot2)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__9() {
                    ...
                    return service.webSites.swapSlots(context.site.webspace, context.site.name, slot1, slot2, __cb(_, __frame, 65, 12, function __$__9() { _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__9() {
  ...
  site.command("start [name]").description($("Start a web site")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __10(name, options, _) { var parsedSiteName, context; var __frame = { name: "__10", line: 790 }; return __func(_, this, arguments, __10, 2, __frame, function __$__10() {
      ...
      return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 10, 10, function __$__10() {

        log.info(util.format($("Starting site %s"), context.site.name));

        return site.doSitePUT(context, { state: "Running" }, __cb(_, __frame, 14, 10, function __$__10() {

          log.info(util.format($("Site %s has been started"), context.site.name)); _(); }, true)); }, true)); }); });


  site.command("stop [name]").description($("Stop a web site")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __11(name, options, _) { var parsedSiteName, context; var __frame = { name: "__11", line: 813 }; return __func(_, this, arguments, __11, 2, __frame, function __$__11() {
      ...
      return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 10, 10, function __$__11() {

        log.info("Stopping site", context.site.name);

        return site.doSitePUT(context, { state: "Stopped" }, __cb(_, __frame, 14, 10, function __$__11() {

          log.info((("Site " + context.site.name) + " has been stopped")); _(); }, true)); }, true)); }); });


  site.command("restart [name]").description($("Stop and then start a web site")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __12(name, options, _) { var parsedSiteName, context; var __frame = { name: "__12", line: 836 }; return __func(_, this, arguments, __12, 2, __frame, function __$__12() {
      ...
      return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 10, 10, function __$__12() {

        log.info(util.format($("Stopping site %s"), context.site.name));
        return site.doSitePUT(context, { state: "Stopped" }, __cb(_, __frame, 13, 10, function __$__12() {

          log.info(util.format($("Site %s has been stopped, restarting"), context.site.name));
          return site.doSitePUT(context, { state: "Running" }, __cb(_, __frame, 16, 10, function __$__12() {
