/*** Generated by streamline 0.4.5 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename),__func=__rt.__func,__cb=__rt.__cb,__tryCatch=__rt.__tryCatch; var crypto = require("crypto");
...
exports.init = function(cli) {
  ...
  vnet.command("show [vnet]").usage("<vnet> [options]").description($("Show details about an Virtual Network")).option("--vnet <vnet>", $("the name of the virtual network")).option("-s, --subscription <id>", $("the subscription id")).execute(showVNet);
  ...
  function registerDNSServer(dnsIp, options, _) { var dnsId, dnsIdPattern, vnetUtil, parsedDnsIp, networkConfiguration, vnetConfiguration, i, progress; var __frame = { name: "registerDNSServer", line: 168 }; return __func(_, this, arguments, registerDNSServer, 2, __frame, function __$registerDNSServer() {
      return cli.interaction.promptIfNotGiven($("DNS IP: "), dnsIp, __cb(_, __frame, 1, 12, function ___(__0, __1) { dnsIp = __1;
        ...
        return getNetworkConfig(options, __cb(_, __frame, 22, 31, function ___(__0, __2) { networkConfiguration = __2;
          ...
          progress = cli.interaction.progress($("Registering DNS Server")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$registerDNSServer() {

                return setNetworkConfig(options, networkConfiguration, __cb(_, __frame, 54, 6, function __$registerDNSServer() { _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$registerDNSServer() {
  ...
  function unregisterDNSServer(dnsIp, options, _) { var filterProperty, filterValue, vnetUtil, parsedDnsIP, networkConfiguration, vnetConfiguration, dnsEntryIndex, i, dnsNameIdentifier, dnsIPAddress, dnsIdAndIp, j, site, k, progress; var __frame = { name: "unregisterDNSServer", line: 228 }; return __func(_, this, arguments, unregisterDNSServer, 2, __frame, function __$unregisterDNSServer() {
      if ((options.dnsId && dnsIp)) {
        return _(new Error($("Either --dns-id or --dns-ip must be present not both"))); } ; return (function __$unregisterDNSServer(__then) {


        if ((!options.dnsId && !dnsIp)) {
          return cli.interaction.promptIfNotGiven($("DNS IP: "), dnsIp, __cb(_, __frame, 6, 14, function ___(__0, __2) { dnsIp = __2; __then(); }, true)); } else { __then(); } ; })(function __$unregisterDNSServer() {
        ...
        return getNetworkConfig(options, __cb(_, __frame, 30, 31, function ___(__0, __3) { networkConfiguration = __3;
            ...
            if (site.DnsServersRef) {
              for (k = 0; (k < site.DnsServersRef.length); k++) {
                if ((site.DnsServersRef[k].Name.toLowerCase() === dnsNameIdentifier)) {
                  return _(new Error(util.format($("You cannot unregister this DNS Server, it is being referenced by the virtual network %s"), site.Name))); } ; }; } ; }; return (function __$unregisterDNSServer(_) {





            var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete the DNS Server %s ? [y/n] "), dnsIdAndIp), __cb(_, __frame, 64, 27, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -227, 18, function ___(__0, __4) { return (function __$unregisterDNSServer(__then) { if (__4) { return _(null); } else { __then(); } ; })(function __$unregisterDNSServer() {



              vnetConfiguration.Dns.DnsServers.splice(dnsEntryIndex, 1);

              progress = cli.interaction.progress(util.format($("Deleting the DNS Server %s"), dnsIdAndIp)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$unregisterDNSServer() {

                    return setNetworkConfig(options, networkConfiguration, __cb(_, __frame, 72, 6, function __$unregisterDNSServer() { _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$unregisterDNSServer() {

                      progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, _); }); }); }, true)); }, true)); }); }); };



  function listVNet(options, _) { var virtualNetworkSites, progress; var __frame = { name: "listVNet", line: 306 }; return __func(_, this, arguments, listVNet, 1, __frame, function __$listVNet() {

      progress = cli.interaction.progress($("Getting virtual networks")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$listVNet() {

            return getVirtualNetworkSites(options, __cb(_, __frame, 4, 28, function ___(__0, __1) { virtualNetworkSites = __1; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$listVNet() {

              progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$listVNet() {
          ...
          cli.interaction.formatOutput(virtualNetworkSites, function(outputData) {
            if ((outputData.length === 0)) {
              ...
              log.table(outputData, function(row, vnet) {
                ...
                row.cell($("AffinityGroup"), vnet.affinityGroup); }); } ; }); _(); }); }); }); };





  function showVNet(vnet, options, _) { var virtualNetworkSites, progress, virtualNetworkSite, i; var __frame = { name: "showVNet", line: 328 }; return __func(_, this, arguments, showVNet, 2, __frame, function __$showVNet() {
      return cli.interaction.promptIfNotGiven($("Virtual network name: "), vnet, __cb(_, __frame, 1, 11, function ___(__0, __1) { vnet = __1;


        progress = cli.interaction.progress($("Getting virtual networks")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$showVNet() {

              return getVirtualNetworkSites(options, __cb(_, __frame, 6, 28, function ___(__0, __2) { virtualNetworkSites = __2; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$showVNet() {

                progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$showVNet() {
            ...
            if (virtualNetworkSites) {
              ...
              log.warn($("No virtual networks found")); } ; _(); }); }); }, true)); }); };



  function deleteVNet(vnet, options, _) { var networkConfiguration, vnetConfiguration, index, i, progress; var __frame = { name: "deleteVNet", line: 362 }; return __func(_, this, arguments, deleteVNet, 2, __frame, function __$deleteVNet() {
      return cli.interaction.promptIfNotGiven($("Virtual Network name: "), vnet, __cb(_, __frame, 1, 11, function ___(__0, __2) { vnet = __2;
        return getNetworkConfig(options, __cb(_, __frame, 2, 31, function ___(__0, __3) { networkConfiguration = __3;

          vnetConfiguration = networkConfiguration.VirtualNetworkConfiguration; return (function __$deleteVNet(__then) {
            if ((vnetConfiguration.VirtualNetworkSites.length > 0)) {
              ...
              for (i = 0; (i < vnetConfiguration.VirtualNetworkSites.length); i++) {
                if (utils.ignoreCaseEquals(vnetConfiguration.VirtualNetworkSites[i].Name, vnet)) {
                  index = i;
                  break; } ; }; return (function __$deleteVNet(__then) {



                if ((index !== -1)) { return (function __$deleteVNet(_) {
                    var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete the virtual network %s ? [y/n] "), vnet), __cb(_, __frame, 15, 31, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -361, 18, function ___(__0, __4) { return (function __$deleteVNet(__then) { if (__4) { return _(null); } else { __then(); } ; })(function __$deleteVNet() {



                      vnetConfiguration.VirtualNetworkSites.splice(index, 1);
                      progress = cli.interaction.progress(util.format($("Deleting the virtual network %s"), vnet)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$deleteVNet() {

                            return setNetworkConfig(options, networkConfiguration, __cb(_, __frame, 22, 10, function __$deleteVNet() { _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$deleteVNet() {
                  ...
                  log.warn(util.format($("Virtual network with name %s not found"), vnet)); __then(); } ; })(__then); } else {


              log.warn($("No virtual networks found")); __then(); } ; })(_); }, true)); }, true)); }); };



  function createVNet(vnet, options, _) { var requiredOptCheckResult, vnetInput, namePattern, vnetUtil, addressSpaceStartIP, parsedAddressSpaceStartIP, addressSpaceInfoForAddressSpace, key, addressSpaceInfo, cidr, maxVmCount, verifyCidrResult, parsedSubnetStartIP, isSubNetInRange, addressSpaceRange, subnetCidr, subnetVmCount, networkConfiguration, vnetConfiguration, i, site, dnsServerNameIps, j, dnsServer, k, affinityGroup, progress, virtualNetworkSite; var __frame = { name: "createVNet", line: 396 }; return __func(_, this, arguments, createVNet, 2, __frame, function __$createVNet() {
      return cli.interaction.promptIfNotGiven($("Virtual network name: "), vnet, __cb(_, __frame, 1, 11, function ___(__0, __1) { vnet = __1;

        if ((!options.location && !options.affinityGroup)) {
          return _(new Error($("Either --location or --affinity-group must be present"))); } else {
          if ((options.location && options.affinityGroup)) {
        ...
        if (options.maxVmCount) {
          ...
          log.info(util.format($("The cidr calculated for the given --max-vm-count %s is %s"), maxVmCount, cidr)); } else {
          if (options.cidr) {
        ...
        if (options.subnetVmCount) {
          ...
          log.info(util.format($("The cidr calculated for the given --subnet-vm-count %s is %s"), subnetVmCount, subnetCidr)); } else {
        ...
        return getNetworkConfig(options, __cb(_, __frame, 295, 31, function ___(__0, __2) { networkConfiguration = __2;
          ...
          for (i = 0; (i < vnetConfiguration.VirtualNetworkSites.length); i++) {
            site = vnetConfiguration.VirtualNetworkSites[i];
            if (utils.ignoreCaseEquals(site.Name, vnetInput.name)) {
              return _(new Error(util.format($("A virtual network with name %s already exists"), vnetInput.name))); } ; };
          ...
          progress = cli.interaction.progress($("Getting or creating affinity group")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$createVNet() {

                return getOrCreateAffinityGroup(options, __cb(_, __frame, 339, 22, function ___(__0, __3) { affinityGroup = __3; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$createVNet() {

                  progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$createVNet() {
              ...
              progress = cli.interaction.progress($("Updating Network Configuration")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$createVNet() {

                    return setNetworkConfig(options, networkConfiguration, __cb(_, __frame, 351, 6, function __$createVNet() { _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$createVNet() {
    ...
    _getAffinityGroups(function(error, groups) {
      ...
      if (options.affinityGroup) {
        ...
        _getLocations(function(error, locations) {
          ...
          var createNewAG = (((affinityGroup === null)) || !_affinityGroupSupportsPersistentVMRole(affinityGroup));
