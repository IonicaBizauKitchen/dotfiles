/*** Generated by streamline 0.4.5 (callbacks) - DO NOT EDIT ***/ "use strict"; var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename),__func=__rt.__func,__cb=__rt.__cb,__tryCatch=__rt.__tryCatch; var util = require("util");
...
exports.init = function(cli) {
  ...
  sbnamespace.command("list").description($("List currently defined service bus namespaces")).option("-s, --subscription <id>", $("the subscription id")).execute(function __1(options, _) { var service, namespaces, progress; var __frame = { name: "__1", line: 41 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
      ...
      progress = cli.interaction.progress($("Getting namespaces")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
            ...
            return service.namespaces.list(__cb(_, __frame, 7, 21, function ___(__0, __1) { namespaces = __1.namespaces; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__1() {
  ...
  sbnamespace.command("show [name]").description($("Get detailed information about a single service bus namespace")).option("-s, --subscription <id>", $("the subscription id")).execute(function __2(name, options, _) { var service, namespace, progress; var __frame = { name: "__2", line: 69 }; return __func(_, this, arguments, __2, 2, __frame, function __$__2() {



      return cli.interaction.promptIfNotGiven($("Service Bus namespace: "), name, __cb(_, __frame, 1, 13, function ___(__0, __1) { name = __1;
        return namespaceNameIsValid(name, __cb(_, __frame, 2, 6, function __$__2() {
          ...
          progress = cli.interaction.progress($("Getting namespace")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {
                ...
                return service.namespaces.get(name, __cb(_, __frame, 9, 20, function ___(__0, __2) { namespace = __2.namespace; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__2() {
  ...
  sbnamespace.command("check <name>").description($("Check that a service bus namespace is legal and available")).usage("[options] <name>").option("-s, --subscription <id>", $("the subscription id")).execute(function __3(name, options, _) { var service, isAvailable, progress; var __frame = { name: "__3", line: 96 }; return __func(_, this, arguments, __3, 2, __frame, function __$__3() {
      ...
      return namespaceNameIsValid(name, __cb(_, __frame, 1, 6, function __$__3() {
        ...
        progress = cli.interaction.progress(util.format($("Checking namespace %s"), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {
              ...
              return service.namespaces.checkAvailability(name, __cb(_, __frame, 8, 22, function ___(__0, __1) { isAvailable = __1.isAvailable; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__3() {
  ...
  sbnamespace.command("create [namespace] [region]").description($("Create a service bus namespace")).usage("[options] <namespace> <region>").option("-n, --namespace <namespace>", $("the namespace name")).option("-r, --region <region>", $("the region to create the namespace in")).option("-s, --subscription <id>", $("the subscription id")).execute(function __4(namespace, region, options, _) { var service, progress, createdNamespace; var __frame = { name: "__4", line: 124 }; return __func(_, this, arguments, __4, 3, __frame, function __$__4() {
      ...
      return cli.interaction.promptIfNotGiven($("Namespace name: "), namespace, __cb(_, __frame, 3, 18, function ___(__0, __1) { namespace = __1;
        return cli.interaction.chooseIfNotGiven($("Region: "), $("Getting regions"), region, function(cb) {
          ...
          service.getServiceBusRegions(function(err, regions) {
            ...
            cb(null, regions.regions.map(function(region) { return region.code; })); }); }, __cb(_, __frame, 4, 15, function ___(__0, __2) { region = __2;


          progress = cli.interaction.progress(util.format($("Creating namespace %s in region %s"), namespace, region));
          return service.namespaces.create(namespace, region, __cb(_, __frame, 12, 29, function ___(__0, __3) { createdNamespace = __3.namespace;
            progress.end();
  ...
  sbnamespace.command("delete [namespace]").description($("Delete a service bus namespace")).option("-n, --namespace <namespace>", $("the namespace name")).option("-q, --quiet", $("quiet mode, do not ask for delete confirmation")).option("-s, --subscription <id>", $("the subscription id")).execute(function __5(namespace, options, _) { var service, progress; var __frame = { name: "__5", line: 151 }; return __func(_, this, arguments, __5, 2, __frame, function __$__5() {





      return cli.interaction.promptIfNotGiven($("Namespace name: "), namespace, __cb(_, __frame, 1, 18, function ___(__0, __2) { namespace = __2; return (function __$__5(_) {

          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete namespace %s? [y/n] "), namespace), __cb(_, __frame, 3, 29, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -150, 18, function ___(__0, __3) { return (function __$__5(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$__5() {
            ...
            progress = cli.interaction.progress(util.format($("Deleting namespace %s"), namespace)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__5() {
                  ...
                  return service.namespaces.delete(namespace, __cb(_, __frame, 11, 8, function __$__5() { _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__5() {
  ...
  location.list = location.command("list").description($("Show list of available service bus locations")).option("-s, --subscription <id>", $("the subscription id")).execute(function __6(options, _) { var service, progress, regions; var __frame = { name: "__6", line: 174 }; return __func(_, this, arguments, __6, 1, __frame, function __$__6() {
      ...
      progress = cli.interaction.progress($("Getting locations")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__6() {
            ...
            return service.getServiceBusRegions(__cb(_, __frame, 5, 18, function ___(__0, __1) { regions = __1.regions; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__6() {
  ...
  function createService(subscription) {
    return utils._createServiceBusClient(profile.current.getSubscription(subscription), log); };};