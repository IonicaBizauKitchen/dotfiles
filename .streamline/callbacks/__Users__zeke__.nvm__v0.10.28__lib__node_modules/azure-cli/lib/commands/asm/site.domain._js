...
exports.init = function(cli) {
  ...
  siteDomain.command("add [domain] [name]").usage("[options] <dn> [name]").description($("Add a site domain")).option("-d, --dn <dn>", $("the new domain name")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __2(dn, name, options, _) { var parsedSiteName, context, siteConfigurations; var __frame = { name: "__2", line: 66 }; return __func(_, this, arguments, __2, 3, __frame, function __$__2() {
      ...
      return cli.interaction.promptIfNotGiven($("Domain name: "), dn, __cb(_, __frame, 1, 11, function ___(__0, __1) { dn = __1;
        ...
        return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 12, 6, function __$__2() {
          ...
          return site.doSiteGet(context, __cb(_, __frame, 14, 31, function ___(__0, __2) { siteConfigurations = __2;
            ...
            return site.doSitePUT(context, {
              hostNames: siteConfigurations.hostNames }, __cb(_, __frame, 16, 6, _, true)); }, true)); }, true)); }, true)); }); });
  ...
  siteDomain.command("delete [dn] [name]").usage("[options] <dn> [name]").description($("Delete a site domain")).option("-d, --dn <dn>", $("the domain name")).option("-q, --quiet", $("quiet mode, do not ask for delete confirmation")).option("--slot <slot>", $("the name of the slot")).option("-s, --subscription <id>", $("the subscription id")).execute(function __3(dn, name, options, _) { var parsedSiteName, context, siteConfigurations, found, i; var __frame = { name: "__3", line: 94 }; return __func(_, this, arguments, __3, 3, __frame, function __$__3() {
      ...
      return cli.interaction.promptIfNotGiven($("Domain name: "), dn, __cb(_, __frame, 1, 11, function ___(__0, __2) { dn = __2; return (function __$__3(_) {

          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete domain name %s? [y/n] "), dn), __cb(_, __frame, 3, 29, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -93, 18, function ___(__0, __3) { return (function __$__3(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$__3() {
            ...
            return site.lookupSiteNameAndWebSpace(context, __cb(_, __frame, 16, 6, function __$__3() {
              ...
              return site.doSiteGet(context, __cb(_, __frame, 18, 31, function ___(__0, __4) { siteConfigurations = __4;
                found = false; return (function __$__3(__then) {
                  if (siteConfigurations.hostNames) {
                    for (i = 0; (i < siteConfigurations.hostNames.length); i++) {
                      ...
                      if (found) {
                        return site.doSitePUT(context, {
                          hostNames: siteConfigurations.hostNames }, __cb(_, __frame, 30, 10, __then, true)); } else { __then(); } ; })(__then); } else { __then(); } ; })(function __$__3() {
